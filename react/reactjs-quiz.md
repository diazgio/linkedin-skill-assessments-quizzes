...
#### Q71. When using a portal, what is the first argument?
...
#### Q73. What is the use of map function below?
...
#### Q74. Describe what is happening in this code?
...
#### Q75. What is wrong with this code?
...
#### Q76. When using a portal, what is the second argument?
...
#### Q77. Given this code, what will be printed in the `<h1>` tag?
...
#### Q78. What is this pattern called?
...
#### Q79. What is the first file loaded by the browser in a basic React project?
...
#### Q80. The code below is rendering nothing, and there is an error that says "ReactDOM is not defined." How do you fix this issue?
...
#### Q81. In this component, how do you display whether the user was logged in or not?
...
#### Q82. You are rendering a list with React when this warning appears in the console: "Warning: Each child in a list should have a unique 'key' prop." How do you fix this issue?
...
#### Q83. How would you generate the boilerplate code for a new app that you are building to collect underpants?
...
#### Q84. Add the code that will fire the photon torpedoes when the button is clicked.
...
#### Q85. What is the process of deciding whether an update is necessary?
...
#### Q86. React is an open-source project but is maintained by which company?
...
#### Q87. What command can you use to generate a React project?
...
#### Q88. What is the browser extension called that React developers use to debug applications?
...
#### Q89. Which tool is not part of Create React App?
...
#### Q90. What is the JavaScript syntax extension that is commonly used to create React elements?
...
#### Q91. How might you check property types without using Flow or TypeScript?
...
#### Q92. How do you add an id of heading to the following h1 element?
...
#### Q93. What value of button will allow you to pass the name of the person to be hugged?
...
#### Q94. What syntax do you use to create a component in React?
...
#### Q95. You want to disable a button so that it does not emit any events onClick. Which prop do you use to acomplish this?
...
#### Q96. In this function, which is the best way to describe the Dish component?
...
#### Q97. When does the componentDidMount function fire?
...
#### Q98. What might you use webpack for?
...
#### Q99. When using the React Developer Tools Chrome extension, what does it mean if the React icon is red?
...
#### Q100. How would you modify the constructor to fix this erroe: "ReferenceError: Must call super constructor in derived class before accessing 'this'..."?
...
#### Q101. Which language can you not use with React?
...
#### Q102. This code is part of an app that collects Pokemon. How would you print the list of the ones collected so far?
...
#### Q103. What would be the result of running this code?
...
#### Q104. Why might you use a React.ref?

...
#### Q63. In the image below, where do you click to hide comments when a document prints?
...
#### Q64. Which page orientation should you select to accommodate a wide chart or table?
...
#### Q65. What is the first step in sharing a document that is currently saved on your local hard drive?
...
#### Q66. You are working in another application and want to move text into a Word document. How can you do it?
...
#### Q67. What is typically created as the first page of a document and contains information such as the document title and author?
...
#### Q68. Before publishing a document you want to identify issues that may make it difficult for people with disabilities to read. which feature should you use?
...
#### Q69. After selecting the entire document, what is the quickest way to find out how many paragraphs there are in your current Word document?
...
#### Q70. You want to be able to read one page in your document while editing another page in the same document. What's the most efficient way to do this with only one monitor?
...
#### Q71. What is the purpose of adding alternative text (alt text) to an image in your document?
...
#### Q73. You want an image to move with the surrounding text as you make changes to the document. Which option should you select?
...
#### Q74. You want to place a triangle shape on your page. Where do you find the shape?
...
#### Q75. When printing multiple copies of a document, which option groups consecutive pages together, making them easier to distribute?
...
#### Q76. You are sharing your computer screen to collaborate on a document. Which view should you use to minimize the ribbon and give your document the most screen space?
...
#### Q77. You want a different header and footer to appear on alternating pages. Which option should you choose?
...
#### Q78. When you start a new, blank document, you usually end up changing the font to Arial 11.5 point. How can you make these settings the default for this and all future new documents?

...
#### Q59. You have an object that needs to follow a specific motion path - including curves, straight lines, and loops - on the slide. Which animation gives the capability to draw this?
...
#### Q60. When you add encryption to a PowerPoint presentation, what does it do?
...
#### Q61. Which type of shape allows you to add text that can be moved around, formatted with styles and effects, or grouped with other objects?
...
#### Q62. You need to apply a special effect that will display as the presentation moves from one slide to the next slide. Which should you apply?
...
#### Q63. Which option can be used to import selected slides from a previously created presentation into a new presention without manually copying and pasting them?
...
#### Q64. The picture on the left is the original image. The image on the right is smaller, but the flowers are the same size and part of the picture has been removed. What method was used to format this picture?
...
#### Q65. Which view allows you to see additional information on a second monitor when delivering a presentation?
...
#### Q66. You are copying and pasting slides from another presentation into your presentation. How will you ensure the new slides are consistent in appearance with your existing slides?
...
#### Q67. What happens when you press the Esc key while playing a **From Current Slide** or **From Beginning** slide show?
...
#### Q68. When you save a presentation with a `.potx` file extension, which type of Powerpoint file is created?
...
#### Q69. You are presenting with two monitors. Which view displays a preview of next slide and speaker notes on the second monitor?
...
#### Q70. Which effect can a presenter use to add motion to an object on a slide?
...
#### Q71. What do the labels introduction and ProjectByMonth indicates?
...
#### Q72. When you copy data from an Excel worksheet into a slide to create a table, which Paste option will allow you to edit the table data in Excel?
...
#### Q73. A few lines of text are overflowing the placeholder on your slide. How can you fix it on your slide?
...
#### Q74. If you want to create an organizational chart that illustrates the reporting relationships within the organization, which SmartArt category would you use?
...
#### Q75. What do the labels Introduction and ProjectsByMonth indicate?

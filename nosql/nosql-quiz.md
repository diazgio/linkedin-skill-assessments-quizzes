...
#### Q15. Which of these data types should you avoid in designing a Google Bigtable row key?
...
#### Q16. Your startup is building a prototype that has an evolving schema. Your data will be eventually consistent. Your application is hosted in AWS. Which databse do you choose?
...
#### Q17. You need to create a scalable databse that allows you to share documents across authorized mobile clients in real time. What Google NoSQL database should you use?
...
#### Q18. You want to test HBase on your laptop using the fewest number of steps. What do you do?
...
#### Q19. You need to design security for DynamoDB to allow users read-obly access to certain items and attriutes in a table. What do you do?
...
#### Q20. You need to design a primary key for DynamoDb based on three attributes. What do you do?
...
#### Q21. What does Redis use to sort the elements of a sorted set?
...
#### Q22. You need to create a document database that supports database triggers. Which NoSQL database should you use?
...
#### Q23. Which statement is preferred Cypher code for Neo4j?
...
#### Q24. You need multi-item ACID transactions with snapshot isolation within a partition for your cloud-based application. Which NoSQL databse do you choose?
...
#### Q25. You need to control your application's batch updates destination for your Bigtable multinode cluster. Which action do you take?
...
#### Q26. Polyglot storage mean using multiple types of what in the same application?
...
#### Q27. Your query to verify that your Redis key is configured to support expiring user information on a defined interval returns -2, What does this value indicate?
...
#### Q28. You are designing a MongoDB schema to support queries that will include lookups. What should you do?
...
#### Q29. What is the aggregation operator for a join concept in MongoDB?
...
#### Q30. For your mobile application, you need to select a Google cloud databse that can support compound, filtered document queries. Which do you choose?
...
#### Q31. To bulk load data into Amazon Neputn, what do you do?
...
#### Q32. You need to create a pub/sub server. Which databse do you use?
...
#### Q33. You want to connect a DynamoDb stream to an AWS lamdba function. Which one of these object do you create.
...
#### Q34. Which two types of indexes are available in Cosmos DB?
...
#### Q35. SQL databses and NoSQL are which types of scalable?
...
#### Q36. You need to create a scalable database that allows you to query data nodes and edges efficiently. What do you use?
...
#### Q37. You are developing a model for a graph database. Your data will be moved from a relational database into Neo4j. Which of these transformations apply?
...
#### Q38. To index a field that holds an array value in MongoDB, which index type do you create?
...
#### Q39. You need to execute a command for MongoDB that does NOT load values from the `.mongorc.js` file. What do you do ?
...
#### Q40. What is the recommended size for Redis keys?
...
#### Q41. You need to store an unordered collection of name-value pairs with differing data types in DynamoDB. Which data type should you choose?
...
#### Q42. Which statement retrieves an item from the MusicCollection table in DynamoDB?
...
#### Q43. Database availability is measured by which metric?
...
#### Q45. You need to generate a unique, sequential identifier for each value stored in a Redis cluster. What do you do?
...
#### Q46. You want to return a list of all elements in two Redis sets. Which keyword do you use?
...
#### Q47. Which method shows you whether MongoDB uses any indexes when running a query, and how the indexes are used?
...
#### Q49. Which command do you use to add a value to a Redis stream named mystream?
...
#### Q50. Which code example completes this statement and creates an index for a MongoDB object named restaurants, sorted ascending by the field name?
...
#### Q51. Which Cypher code executes the multiquery block?
...
#### Q52. You need to create a scalable database that supports immutable writes. What do you use?
...
#### Q53. You need to create a data store for the catalog for your new ecommerce application. Your company is a startup, so the catalog schema may evolve. Which do you choose?
...
#### Q54. You need to select a NoSQL database for heavy aggregate query workloads. Which type do you choose?
...
#### Q55. You need to select a columnstore database that enforce built-in data types. You want to add indexes to improve performance for known workloads. Which do you choose?

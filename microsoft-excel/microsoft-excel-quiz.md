...
#### Q51. Which of these functions returns the largest value among all values within the range H2:H30?
...
#### Q52. You select cell A1, hover the pointer over the cell border to reveal the move icon, then drag the cell to a new location. Which ribbon commands achieve the same result?
...
#### Q53. You want to add a column to the PivotTable below that shows a 5% bonus for each sales rep. That data does not exists in the original data table. How can you do this without adding more data to the table?
...
#### Q56. Cell A2 contains the value 8 and cell B2 contains the value 9. What happens when cells A2 and B2 are merged and then unmerged?
...
#### Q57. In the formula `=VLOOKUP(A1,D1:H30,3,FALSE)`, the lookup value (A1) is being looked for in **\_**.
...
#### Q58. An .xlsx workbook is saved into .csv format. What is preserved in the new .csv file?
...
#### Q59. Which function, when entered into cell G7, allows you to determine the sum total of annual sles for market regions 18 and greater?
...
#### Q60. Which function, when entered into cell F2 and then dragged to cell F6, returns the performance rating text (e.g., "Good", "Poor") for each representative?
...
#### Q61. What is `Colors[Inventory]` referring to here?
...
#### Q62. Which VLOOKUP function, when entered into cell L2 and then dragged to cell L5, returns the average number of calls for the representative IDs listed in column J?
...
#### Q63. Which formula calculates the total value of a single row of cells across a range of columns?
...
#### Q64. Which value is returned when you enter `=LEN(C3)` into cell F3?
...
#### Q65. How can you create the lower table from the top one when the tables are `not` linked?
...
#### Q66. Which function returns the number of characters in a text string in cell A1?
...
#### Q67. Which formula, when entered into cell D2 and then dragged to cell D6, calculates the average total number of minutes spent on phone calls for each representative?
...
#### Q68. The PivotTable below has one row field and two column fields. How can you pivot this table to show the column fields as subtotals of each value in the row field?
...
### Q69. Which Excel feature allows you to hide rows or columns with an easily visible expand/collapse?
...
#### Q70. Monthly revenues of 2019 are entered in B2:M2, as shown below, To get year-to-date running total revenues, what formula should you enter in B3 and autofill through M3?
...
#### Q71. If a worksheet has the value 27 in cell B3, what value is returned by the `function =MOD(B3,6)`?
...
#### Q72. From which field list was the pivotTalble created?
...
#### Q73. In the worksheet shown below, cell C6 contains the `formula=VLOOKUP(A6,$F$2:$G$10,2,FALSE)`. What is the most likely reason that `#N/A` is returned in cell `C6` instead of mallory's `ID (2H54)`
...
#### Q74. What is the difference between pressing the delete key and using the clear command in the Home tab's Editing group?
...
#### Q75. What is the intersection of a worksheet row and column?
...
#### Q76. In this PivotTable, the continuous variable weight is shown in the _Row_ field. Another continuous variable is in the _Sum Values_ field. It is important to reduce a long list of body weights to a smaller set of weight categories. How do you do this?
...
#### Q77. How can you drill down into a PivotTable to show details?
...
#### Q78. To ensure the VLOOKUP function returns the value of an exact match, what do you need to enter into the Range_lookup field?
...
#### Q79. Cell D2 contains the formula =B2-C2. What is the fastest way to copy that formula into cells D3:D501 (the bottom of the data set)?
...
#### Q80. This data needs to be sorted by Group, then by Last Name, then by First Name. How do you accomplish this?
...
#### Q81. How can you use Format Painter to apply the format of a single source cell to several nonadjacent destination cells?
...
#### Q82. Which is a valid Excel formula?
...
#### Q83. Columns D, E, and F are hidden in your worksheet. What is one way to unhide these columns?
...
#### Q84. Before publishing a document, you want to identify issues that may make it difficult for people with disabilities to read. Which feature should you use?
...
#### Q85. How do you remove the background of an inserted image?
...
#### Q86. What is the result of the formula =4&3?
...
#### Q87. How do you remove everything (values, formatting, etc.) from a cell?
...
#### Q88. What is the difference between a workbook and a worksheet?
...
#### Q89. How would you connect the slicer to both PivotTables?
...
#### Q90. Which formula contains a valid absolute reference?
...
#### Q91. What happens if you use the **AutoSum** button in cell H4?
...
#### Q92. To create this PivotTable, drag the _ field to the Rows area and the _ field to the Values area?
...
#### Q95. How would you search an entire workbook with **Find & Select**?
...
#### Q96. How do you create a heatmap in a table, such as this one, which is responsive to the values?
...
#### Q97. To split text across cells without using Merge & Center, click **Formt Cells**. The, on **Alignment** tab, click**\_**.
...
#### Q98. In the worksheet below, what do the symbols in rows 4, 6, 7, and 11 indicate?
...
#### Q99. You are determining `%` growth by dividing Growth by Sales. Which Excel function would you use to avoid #DIV/0! errors?
...
#### Q100. You have a worksheet in Excel that will print as 10 pages. How can you ensure that the header row is printed at the top of each page?
...
#### Q101. Which value is returned when you enter this function into cell G2? `=IF(SUM(F2:F6)>12,"Too Many Tardy Days","No Tardiness Issue")`
...
#### Q102. What ribbon command on the Home tab can you use to change a cell's fill color automatically, based on the value of the cell?
...
#### Q103. In this worksheet, how are cells A2:D2 related to cell C4?
...
#### Q104. What is the name given to the numbers in or above each bar in a column chart, as shown?
...
#### Q105. Which chart type provides the best visual display of the releationship between two numeric variables?
...
#### Q106. To ensure that a collection of shapes are evenly spaced apart from left to right, select the shapes, click Page Layout > Align, and then click **\_\_**.
...
#### Q107. A file extension of .xlsm indicates what type of workbook?
...
#### Q108. How do you remove only the conditional formatting from a cell and leave all other formatting intact?
...
#### Q109. If a range name is used in a formula and the name is deleted, what happens to the formula?
...
#### Q110. To insert a new column to the left of a specific column, right-click the header containing the column's letter and select **\_**.
...
#### Q111. You want to restrict the values entered in a cell to a specified set, such as Hop, Skip, Jump. Which type of data validation should you use?
...
#### Q113. You want to find the second-largest invoice in a column containing all the invoices in a given month. What function would you use?
...
#### Q114. How can you see the data in column E?
...
#### Q115. In the worksheet below, a table called Projects extends from cell A1 to D10. Cell D1 contains the text Status. Cell E12 contains the formula =Projects[@Status]. What does this formula return?
...
#### Q116. Which Excel feature allows you to select all cells in the column with inconsistent formulas compared to the rest of the column?
...
#### Q117. What is one way to center text in a cell?
...
#### Q118. Cell D1 contains the value 7.877. You want cell D1 to display the value as 7.9 but keep the original number in calculations. How can yu=ou accomplish this?
...
#### Q119. Given the image below, what happens if you type "P"in cell A6?
...
#### Q120. To insert a new column to the left of a specific column, right-click the header containing the column's letter and select **\_**.
...
#### Q121. Your transactions data set contains more than 10,000 rows. Some rows contain the same transaction. How would you remove the rows containing the identical transactions?
...
#### Q122. A colleague shared an excel file with you, and you want to display a worksheet that is hidden in it. How you can do that?
